...
{
    public class ColorDateTimePicker : DateTimePicker
    {
        private Color _backDisabledColor;

        public ColorDateTimePicker() : base()
        {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            g.DrawLine(Pens.Black, 0, this.ClientSize.Height - 1, this.ClientSize.Width, this.ClientSize.Height - 1);
            g.DrawLine(Pens.Black, 0, 0, 0, this.ClientSize.Height - 1);
            g.DrawLine(Pens.Black, 0, 0, this.ClientSize.Width - 1, 0);
            g.DrawLine(Pens.Black, this.ClientSize.Width - 1, 0, this.ClientSize.Width - 1, this.ClientSize.Height - 1);
